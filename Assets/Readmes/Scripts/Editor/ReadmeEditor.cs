...
namespace ETC.KettleTools {
    ...
    public class ReadmeEditor : Editor {
        ...
        static string s_ReadmeSourceDirectory = "Assets/Readmes/SceneReadmes";
        ...
        static void SelectSceneReadme(Scene newScene) {

            string path = newScene.path;
            var sceneImporter = AssetImporter.GetAtPath(path);
            if (sceneImporter.userData != "") {
